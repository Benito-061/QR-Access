...
class Ceremony extends Model
{
    ...
    {
        return $this->hasOne(CeremonyManagement::class);
    }
    ...
    /** Format compatible avec l'ancien frontend (localStorage). */
    public function toLegacyArray(): array
    {
        return [
            ...
            'data' => [
                ...
                'church' => $this->church,
                'churchAddress' => $this->church_address,
                'photographer' => $this->photographer,
                'reception' => $this->reception,
                'brideName' => $this->bride_name,
                'groomName' => $this->groom_name,
                'family1' => $this->family1,
                'family2' => $this->family2,
                'program' => $this->program,
                'notes' => $this->notes,
            ],
            'guests' => $this->guests->map(fn (Guest $g) => $g->toLegacyArray())->all(),
        ];
    }
}
